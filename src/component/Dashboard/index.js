...
export default function Dashboard() {
  ...
  const getStaffsUrl = "https://654909ffdd8ebcd4ab241778.mockapi.io/api/Lab7";
  const deleteStaffsUrl = `https://654909ffdd8ebcd4ab241778.mockapi.io/api/Lab7`;
  ...
  return (
    <div>
      <h4 className="font-pages">
        {name.name == "no"
          ? "Bạn chưa đăng nhập vui lòng nhấn vào DASHBOARD để đăng nhập !"
          : `hello, ${name.name}`}
      </h4>
